...
<head>
  ...
  <title>Painel Administrador | SisOuvWeb</title>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              ...
              <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                ...
                <span class="hidden-xs">Paulo Spiguel</span>
              </a>
              <ul class="dropdown-menu">
                ...
                <li class="user-footer">
                  <div class="pull-left">
                    <a href="#" class=" glyphicon glyphicon-user btn btn-default btn-flat">Perfil</a>
                  </div>
                  <div class="pull-right">
                    <a href="/AdminPainel/logout" class="glyphicon glyphicon-log-out btn btn-default btn-flat">Sair</a>
                  </div>
                </li>
              </ul>
            </li>
